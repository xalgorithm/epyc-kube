...
if [ -n "$POD_NAME" ]; then
    ...
    echo "  - Auth URL: https://login.xalg.im/realms/xalg-apps/protocol/openid-connect/auth"
    echo "  - Token URL: https://login.xalg.im/realms/xalg-apps/protocol/openid-connect/token"
    echo "  - User Info URL: https://login.xalg.im/realms/xalg-apps/protocol/openid-connect/userinfo"
