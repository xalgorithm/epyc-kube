...
curl -s \
    --header "X-Vault-Token: $ROOT_TOKEN" \
    --request POST \
    --data "{\"data\": {\"smtp_host\": \"smtp.gmail.com:587\", \"smtp_from\": \"contact@example.com\", \"smtp_username\": \"contact@example.com\", \"smtp_password\": \"${SMTP_PASSWORD:-'app-password-here'}\", \"recipient_email\": \"admin@example.com\"}}" \
