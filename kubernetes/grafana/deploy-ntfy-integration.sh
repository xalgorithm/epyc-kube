  ...
  notifiers.yaml: |
    ...
    notifiers:
      ...
      - name: ntfy-critical
        ...
        disable_resolve_message: false
        settings:
          url: https://notify.xalg.im/critical-alerts
          httpMethod: POST
          httpHeaders:
            Priority: urgent
...
echo "- Regular alerts: https://notify.xalg.im/monitoring-alerts"
echo "- Critical alerts: https://notify.xalg.im/critical-alerts"
echo ""
...
echo "3. You can also access notifications via web browser at https://notify.xalg.im"
echo ""
echo "To test the integration, create a test alert in Grafana or run:"
echo "curl -d \"Test alert from monitoring system\" https://notify.xalg.im/monitoring-alerts"
echo ""
