...
cat > ntfy-contact-point.json << EOF
{
  ...
  "type": "webhook",
  "settings": {
    "url": "https://notify.xalg.im/$MONITORING_TOPIC",
    "httpMethod": "POST",
    "username": "",
    "password": "",
...
cat > ntfy-critical-contact-point.json << EOF
{
  ...
  "type": "webhook",
  "settings": {
    "url": "https://notify.xalg.im/$CRITICAL_TOPIC",
    "httpMethod": "POST",
    "httpHeaders": {
      "Priority": "urgent",
...
echo "1. Subscribe to the '$MONITORING_TOPIC' topic in the ntfy app or web interface (https://notify.xalg.im/$MONITORING_TOPIC)"
...
echo "  - Regular alerts: https://notify.xalg.im/$MONITORING_TOPIC"
echo "  - Critical alerts: https://notify.xalg.im/$CRITICAL_TOPIC" 