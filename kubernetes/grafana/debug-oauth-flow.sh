...
LOGIN_PAGE=$(curl -s https://grafana.xalg.im/login)
...
if echo "$LOCATION_HEADER" | grep -q "login.xalg.im"; then
...
echo "   - Visit: https://grafana.xalg.im/login"
...
echo "   - https://grafana.xalg.im/login/oauth"
echo "   - https://grafana.xalg.im/oauth/callback"
echo ""
...
echo "  - https://grafana.xalg.im/login/generic_oauth"
echo "  - https://grafana.xalg.im/login/oauth"
echo "  - https://grafana.xalg.im/oauth/callback"
echo "  - https://grafana.xalg.im/api/auth/callback"
echo "  - https://grafana.xalg.im/auth/callback"
echo "  - https://grafana.xalg.im/*"
echo "  - https://grafana.xalg.im/"
