...
run_test "Ingress has correct host" "kubectl get ingress wordpress-ingress -n $NAMESPACE -o jsonpath='{.spec.rules[0].host}' | grep -q ethos.xalg.im"
...
if [[ $TESTS_FAILED -eq 0 ]]; then
    ...
    echo "Production access: https://ethos.xalg.im"
