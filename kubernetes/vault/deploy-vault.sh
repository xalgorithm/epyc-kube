...
VAULT_DOMAIN=${VAULT_DOMAIN:-"vault.xalg.im"}
...
curl -s \
    --header "X-Vault-Token: $ROOT_TOKEN" \
    --request POST \
    --data "{\"data\": {\"smtp_host\": \"smtp.gmail.com:587\", \"smtp_from\": \"find.me@xalg.im\", \"smtp_username\": \"find.me@xalg.im\", \"smtp_password\": \"${SMTP_PASSWORD:-'app-password-here'}\", \"recipient_email\": \"x.algorithm@gmail.com\"}}" \
