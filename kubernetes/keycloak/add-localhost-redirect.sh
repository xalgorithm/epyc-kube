...
KEYCLOAK_ADMIN_PASSWORD="Pr1amsf0lly!"
...
UPDATED_CONFIG=$(echo "$CURRENT_CONFIG" | jq '
    .redirectUris = [
        "https://grafana.xalg.im/login/generic_oauth",
        "http://localhost:3000/login/generic_oauth",
        "http://127.0.0.1:3000/login/generic_oauth",
        "https://grafana.xalg.im/login/oauth",
        "https://grafana.xalg.im/oauth/callback",
        "https://grafana.xalg.im/api/auth/callback",
        "https://grafana.xalg.im/auth/callback",
        "https://grafana.xalg.im/*",
        "https://grafana.xalg.im/"
    ] |
    .webOrigins = ["https://grafana.xalg.im", "http://localhost:3000", "*"]
')
